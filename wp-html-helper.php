...
// image default alt
if( ! function_exists( 'prefix_img_default_alt' ) ) {
	function prefix_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'prefix_img_tag' ) ) {
	function prefix_img_tag( array $args ) {
...
// Anchor Tag
if( ! function_exists( 'prefix_anchor_tag' ) ) {
	function prefix_anchor_tag( array $args ) {
...
// Heading Tag
if( ! function_exists( 'prefix_heading_tag' ) ) {
	function prefix_heading_tag( array $args ) {
...
// Paragraph Tag
if( ! function_exists( 'prefix_paragraph_tag' ) ) {
	function prefix_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'prefix_other_tag' ) ) {
	function prefix_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'prefix_button_element ' ) ) {
	function prefix_button_element( array $args ) {
